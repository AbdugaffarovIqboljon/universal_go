// lib/features/customer/presentation/pages/home/home_screen.dart
    ...
    if (userPosition != null) {
      final userPlacemark = PlacemarkMapObject(
        ...
        icon: PlacemarkIcon.single(
          PlacemarkIconStyle(
            image: BitmapDescriptor.fromAssetImage('assets/icons/ic_user_location.png'),
            scale: 0.3,
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          // Map overlay buttons - FIXED POSITIONING
          Positioned(
            right: 16.w,
            bottom: 220.h,
            child: MapOverlayButtons(
              onMyLocationPressed: _getCurrentLocation,
              onLayersPressed: () {
                // TODO: Change map layers
              },
              isDark: isDark,
            ),
          ),
          
          // Store info card when marker tapped
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  height: 4.h,
                  decoration: BoxDecoration(
                    color: widget.isDark ? const Color(0xFF334155) : Colors.grey[300],
                    ...
                    children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                Icon(
                                  Icons.arrow_upward,
                                  size: 16.sp,
                                  color: widget.isDark ? const Color(0xFFCBD5E1) : Colors.grey[600],
                                ),
                                SizedBox(width: 8.w),
                                Text(
                            ...
                            children: [
                              Text(
                                ...
                                style: TextStyle(
                                  ...
                                  color: widget.isDark ? const Color(0xFFF1F5F9) : Colors.black,
                                ),
                              ),
                              SizedBox(width: 8.w),
                              Container(
                      ...
                      ListView.builder(
                        ...
                        itemCount: _showAllTopSellers 
                            ...
                            : (widget.topRatedStores.length > 3 ? 3 : widget.topRatedStores.length),
                        itemBuilder: (context, index) {
                        ...
                        Padding(
                          ...
                          child: TextButton(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  _showAllTopSellers ? 'Show Less' : 'View All (${widget.topRatedStores.length})',
                                  style: TextStyle(
                                    fontSize: 14.sp,
                                ...
                                SizedBox(width: 4.w),
                                Icon(
                                  _showAllTopSellers ? Icons.keyboard_arrow_up : Icons.keyboard_arrow_down,
                                  color: Theme.of(context).primaryColor,
                                  size: 18.sp,
                                ),
                              ],
